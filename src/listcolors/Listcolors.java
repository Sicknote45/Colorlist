        ...
        public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
                ...
                if(cmd.getName().equalsIgnoreCase("Dcolors")){
                        if (p.hasPermission("Donator")){
                        	p.sendMessage(ChatColor.BOLD + "" + ChatColor.GOLD + "=-=-=Below a list of possible colors for your rank, to see what it would look like in an example type / Colortext [Color] [Rank Name]=-=-=");
                                ...
                                p.sendMessage(ChatColor.DARK_PURPLE + "This is Dark Purple text");
                                    ...
                                    if (p.hasPermission("Donator")){
                                            if(args.length >= 1){
                                                    if(args[0].equalsIgnoreCase("red")){
                                                            if(args.length == 3){
                                                                    p.sendMessage(ChatColor.RED + args[1] + " " + args[2]);
                                                            }
                                                            if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("green")){
                                                            if(args.length == 3){
                                                                    p.sendMessage(ChatColor.GREEN + args[1] + " " + args[2]);
                                                            }
                                                            if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("dark green")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.DARK_GREEN + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("dark red")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.DARK_RED + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("dark gray")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.DARK_GRAY + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("dark purple")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.DARK_PURPLE + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                        ...
                                                        if(args[0].equalsIgnoreCase("dark aqua")){
                                                            if(args.length == 3){
                                                                    p.sendMessage(ChatColor.DARK_AQUA + args[1] + " " + args[2]);
                                                            }
                                                            if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("black")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.BLACK + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("dark blue")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.DARK_BLUE + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("gold")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.GOLD + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("gray")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.GRAY + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("blue")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.BLUE + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("light purple")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.LIGHT_PURPLE + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("aqua")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.AQUA + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("yellow")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.YELLOW + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
                                                    ...
                                                    if(args[0].equalsIgnoreCase("white")){
                                                        if(args.length == 3){
                                                                p.sendMessage(ChatColor.WHITE + args[1] + " " + args[2]);
                                                        }
                                                        if(args.length == 2){
